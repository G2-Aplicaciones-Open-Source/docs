...
- [Capítulo V: Product Implementation, Validation \& Deployment](#capítulo-v-product-implementation-validation--deployment)
  ...
  - [Agency Documents](#agency-documents)
  ...
  - [Reviews](#reviews)
  - [Users](#users)
- [| **GET** | `/api/v1/users/{userId}` | Obtener usuario por ID     |](#-get--apiv1usersuserid--obtener-usuario-por-id-----)
  - [Agencies](#agencies)
...
-Bounded Context Bookings & Payments
<p align="center">
    <img src="assets/recursos/diagrama_componentes_bookings_payments.png" alt="Diagrama de Componentes Bookings & Payments Bounded Context"/>
</p>
