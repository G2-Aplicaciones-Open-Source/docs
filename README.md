...
| US33 | Soporte prioritario | Como agencia, quiero acceder a soporte rápido para resolver problemas urgentes. | <p>- Scenario 1: Notificación de consulta recibida<br>Dado que contacto a soporte, cuando envío mi consulta, entonces recibo una confirmación de recepción.</p><p>- Scenario 2: Tiempo de respuesta estimado<br>Dado que recibo una confirmación de consulta recibida, cuando reviso los detalles, entonces verifico que el plazo de respuesta sea de 24h.</p> | EP03 |
