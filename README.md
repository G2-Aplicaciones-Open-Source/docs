...
| *Sprint3*       |                      |        |                              |                                                                 | *Estimation (Hours)* | *Assigned to*                | *Status*     |
|----------------|----------------------|--------|------------------------------|-----------------------------------------------------------------|-----------------------|------------------------------|--------------|
| *User Story*   | *Work-Item / Task*   |        |                              |                                                                 |                       |                              |              |
| *ID*           | *Title*              | *Id*   | *Title*                     | *Description*                                                   |                       |                              |              |
| US-51          | Gestión de media     | T51-1  | Subir media para experiencia | Permitir que la agencia suba imágenes o videos relacionados a sus tours. | 1                     | Linares Bernable, Cesar     | To-do        |
|                |                      | T51-2  | Ver media por experiencia    | Mostrar archivos multimedia asociados a una experiencia.        | 0.5                   | Guevara Tejada, Jorge       | To-do        |
| US-52          | Autenticación segura | T52-1  | Interfaz de login            | Diseñar pantalla de inicio de sesión con validación de campos. | 0.5                   | Aspajo Alvarez, Mathias     | To-do        |
|                |                      | T52-2  | Implementar lógica de login  | Integrar API de autenticación y manejo de token.               | 1                     | Aspajo Alvarez, Mathias     | To-do        |
| US-53          | Staff de agencias    | T53-1  | Crear staff                  | Desarrollar formulario para registrar nuevo personal.          | 0.5                   | Galvez Chambi, Jhon         | To-do        |
|                |                      | T53-2  | Listar staff                 | Mostrar tabla con listado del personal por agencia.             | 0.5                   | Galvez Chambi, Jhon         | To-do        |
| US-54          | Documentos legales   | T54-1  | Subir documentos             | Crear sección para cargar documentos con validaciones.          | 0.5                   | Linares Bernable, Cesar     | To-do        |
|                |                      | T54-2  | Ver documentos               | Mostrar documentos subidos por agencia con opción de descarga. | 0.5                   | Linares Bernable, Cesar     | To-do        |
| US-55          | Disponibilidad       | T55-1  | Crear disponibilidad         | Permitir definir fechas y cupos para experiencias.              | 1                     | Briceño De La Cruz, Farid   | To-do        |
|                |                      | T55-2  | Asociar tipo de ticket       | Asociar tipos de ticket a disponibilidades (precio y cantidad). | 1                     | Briceño De La Cruz, Farid   | To-do        |
| US-56          | Carrito de compra    | T56-1  | Añadir al carrito            | Implementar botón de añadir experiencia al carrito.             | 0.5                   | Aspajo Alvarez, Mathias     | To-do        |
|                |                      | T56-2  | Ver carrito                  | Diseñar página donde el usuario puede ver y editar su carrito. | 1                     | Aspajo Alvarez, Mathias     | To-do        |
| US-57          | Reviews              | T57-1  | Enviar reseña                | Permitir a usuarios calificar experiencias con comentarios.     | 0.5                   | Galvez Chambi, Jhon         | To-do        |
|                |                      | T57-2  | Ver reseñas por experiencia  | Mostrar todas las reseñas de una experiencia.                   | 0.5                   | Galvez Chambi, Jhon         | To-do        |
| US-58          | Gestión de roles     | T58-1  | Ver roles disponibles        | Mostrar en formulario roles disponibles para registro de usuarios. | 0.5                | Guevara Tejada, Jorge       | To-do        |
|                |                      | T58-2  | Asignar rol en registro      | Asociar rol al usuario durante el registro mediante dropdown.   | 0.5                   | Guevara Tejada, Jorge       | To-do        |
